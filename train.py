...
from util import *
import random
from model_GPT4ST import GPT4ST
from ranger21 import Ranger
import torch.optim as optim

parser = argparse.ArgumentParser()
parser.add_argument("--device", type=str, default="cuda:1", help="")
parser.add_argument("--data", type=str, default="taxi_drop", help="data path")
...
parser.add_argument("--epochs", type=int, default=100, help="") # 500
...
class trainer:
    def __init__(
        ...
        self.model = GPT4ST(
            device, adj_mx, input_dim, channels, num_nodes, input_len, output_len, dropout
        )
        self.model.to(device)
        self.optimizer = Ranger(self.model.parameters(), lr=lrate, weight_decay=wdecay)
        # self.optimizer = optim.Adam(self.model.parameters(), lr=lrate, weight_decay=wdecay)
        # self.scheduler = optim.lr_scheduler.CosineAnnealingLR(self.optimizer, T_max = 10, eta_min=1e-8)
