...
graph_pkl_filename = 'data/bike_pick/adj_mx.pkl'
...
class PFA(nn.Module):
    ...
    def custom_forward(self,
                    ...
                    adjacency_matrix: Optional[torch.FloatTensor] = None,  # 添加 adjacency_matrix 参数
                    ) -> Union[Tuple, dict]:
        ...
        for i, (block, layer_past) in enumerate(zip(self.gpt2.h, past_key_values)):
            ...
            if i >= total_layers - self.U and adjacency_matrix is not None:
                # 使用 adjacency_matrix 作为 attention_mask
